...
export const putUpateProfileImage = async (id, param) => {
  try {
    const res = await axiosInstance.put(
      `/memorial-profiles/${id}/profile-image`,
      param
    );
    return res;
  } catch (err) {
...
export const putUpateBackgroundImage = async (id, param) => {
  try {
    const res = await axiosInstance.put(
      `/memorial-profiles/${id}/background-image`,
      param
    );
    return res;
  } catch (err) {
...
export const putUpateDescription = async (id, param) => {
  try {
    const res = await axiosInstance.put(
      `/memorial-profiles/${id}/description`,
      param
    );
    return res;
  } catch (err) {
...
//추모 프로필 조회
export const getSelectProfileList = async (
  page = 1,
  pageSize = 20,
  mockResult = 0
) => {
  try {
    const res = await axiosInstance.get(
      '/members/me/memorial-profiles/my-everlinks',
      {
        params: {
          page,
          pageSize,
...
//추모 view 조회
export const getSelectProfileViewList = async (
  page = 1,
  pageSize = 20,
  mockResult = 0
) => {
...
//추모 bookmarks 조회
export const getSelectProfileBookmarksList = async (
  page = 1,
  pageSize = 20,
  mockResult = 0
) => {
  try {
    const res = await axiosInstance.get(
      '/members/me/memorial-profiles/bookmarks',
      {
        params: {
          page,
          pageSize,
...
export const deleteEditorProfile = async (id) => {
  try {
    const res = await axiosInstance.delete(
      `/members/me/memorial-profiles/${id}/permissions/editor`
    );
    return res;
  } catch (err) {
    throw new Error(err.response?.data?.message || '처리 중 오류가 발생했습니다.');
...
export const deleteViwerProfile = async (id) => {
  try {
    const res = await axiosInstance.delete(
      `/members/me/memorial-profiles/${id}/permissions/viewer`
    );
    return res;
  } catch (err) {
    throw new Error(err.response?.data?.message || '처리 중 오류가 발생했습니다.');
...
export const deleteBookmarksProfile = async (id) => {
  try {
    const res = await axiosInstance.delete(
      `/bookmarks/memorial-profiles/${id}`
    );
    return res;
  } catch (err) {
    throw new Error(err.response?.data?.message || '처리 중 오류가 발생했습니다.');
...
//추모 이미지 리스트 조회
export const getPhotoSeletct = async (
  id,
  type,
  page = 1,
  pageSize = type === 'edit' ? 20 : 21
) => {
  try {
...
export const getLetter = async (profileId, letterId) => {
  try {
    const res = await axiosInstance.get(
      `/memorial-profiles/${profileId}/letters/${letterId}`
    );
    return res;
  } catch (err) {
    throw new Error(err.response?.data?.message || '처리 중 오류가 발생했습니다.');
...
export const postLetters = async (profileId, params) => {
  try {
    const res = await axiosInstance.post(
      `/memorial-profiles/${profileId}/letters`,
      params
    );
    return res;
  } catch (err) {
    const message = err.response?.data?.message || err.response?.data?.error || '알 수 없는 오류가 발생했습니다.';
...
export const deleteLetters = async (profileId, lettersId) => {
  try {
    const res = await axiosInstance.delete(
      `/memorial-profiles/${profileId}/letters/${lettersId}`
    );
    return res;
  } catch (err) {
    throw new Error(err.response?.data?.message || '처리 중 오류가 발생했습니다.');
...
export const postEmailInvitations = async (profileId, params) => {
  try {
    const res = await axiosInstance.post(
      `/memorial-profiles/${profileId}/invitations`,
      {
...
//초대받은 계정의 권한 변경
export const putInvitationPermissions = async (
  profileId,
  invitationId,
  params
) => {
  try {
    const res = await axiosInstance.put(
      `/memorial-profiles/${profileId}/invitations/${invitationId}/permissions`,
      {
        permission: params,
      }
    );
...
//초대받은 계정의 권한 삭제
export const deleteInvitationPermissions = async (
  profileId,
  invitationId,
  params
) => {
...
export const deleteInvitationCancel = async (profileId, invitationId) => {
  try {
    const res = await axiosInstance.delete(
      `/memorial-profiles/${profileId}/invitations/${invitationId}`
    );
    return res;
  } catch (err) {
    throw new Error(err.response?.data?.message || '처리 중 오류가 발생했습니다.');
...
export const putProfileScope = async (profileId, params) => {
  try {
    const res = await axiosInstance.put(
      `/memorial-profiles/${profileId}/scope`,
      {
        scope: params,
      }
    );
...
export const getPrivateProfileAccessRequests = async (
  profileId,
  page = 1,
  pageSize = 10
) => {
  try {
    const res = await axiosInstance.get(
      `/memorial-profiles/${profileId}/requests`,
      {
        params: {
          profileId,
          page,
...
export const putPrivateAccessRequests = async (
  profileId,
  requestId,
  status
) => {
...
export const putConfirmInvitation = async (params) => {
  try {
    const res = await axiosInstance.put(
      '/memorial-profiles/invitations.resolve',
      params
    );
    return res;
  } catch (err) {
