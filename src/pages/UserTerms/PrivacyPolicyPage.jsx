const PrivacyPolicyPage = () => {
  ...
  ** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는 서식으로 쇼핑몰 운영형태에 따른 수정이 필요합니다. 쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한 내용을 반영하여 사용하시기 바랍니다. **
  ...
  (주)○○○ 개인정보처리방침(주)○○○은 (이하 "회사"는) 「개인정보 보호법」 제30조에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.
  ...
   제공받는 제3자명 제공 목적 제공하는 개인정보 항목 제공받는 자의 보유 및 이용 기간 [제공받는 제3자명] [제공 목적] [제공하는 개인정보 항목] [제공받는 자의 보유 및 이용 기간]
  ...
   수탁업체 위탁업무 카페24(주) 쇼핑몰 호스팅 서비스의 시스템 제공 및 유지∙보수 [택배사 이름] [택배사 위탁 내용] [PG사 이름] [PG사 위탁 내용] #supply_list# [위탁업무 내용]
  ...
  o 개인정보 보호책임자성명 : OOO소속 : OOO전화번호 : OO-OOO-OOOO이메일 :
  o 개인정보 보호담당자성명 : OOO소속 : OOO전화번호 : OO-OOO-OOOO이메일 :
