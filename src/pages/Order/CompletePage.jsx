...
const CompletePage = () => {
  ...
  return (
    <>
      <section className="pt-15 pb-1">
        <div className="container">
          <h4 className="mb-2 fs-40 fw-400 pb-1 text-center text-black">
            주문이 정상적으로 완료되었습니다.
          </h4>
          <h6 className="mb-2 fs-32 fw-400 pb-1 text-center text-black">
            주문번호 : <span className="text-base-color"> 202412040234234</span>
          </h6>
          <div className="row">
            <div className="d-flex justify-content-center   me-15px xs-mb-15px">
              <Button
                size="large"
                radiusOn="radius-on"
                className="btn btn-extra-large btn-white undefined d-table d-lg-inline-block lg-mb-15px me-10px"
              >
                주문 상세보기
              </Button>
              <Button
                size="large"
                radiusOn="radius-on"
                className="btn btn-extra-large btn-base-color undefined d-table d-lg-inline-block lg-mb-15px"
              >
                My EverLinks
              </Button>
            </div>
      ...
      <section className="p-0">
        <div className="container pt-4  border-bottom border-2 border-black">
          <h6 className="fs-40 fw-400 border-black text-start text-black m-0">
            배송지
          </h6>
          <div className="row row-cols-1 row-cols-lg-2 row-cols-md-1 g-0 justify-content-start pt-3 ps-5">
      ...
      <section className="pb-20">
        <div className="container border-bottom border-2 border-black">
          <h6 className="fs-40 fw-400 border-black text-start text-black m-0">
            최종 결제 정보
          </h6>
          <div className="row row-cols-1 row-cols-lg-2 row-cols-md-1 g-0 justify-content-start pt-3 ps-5">
